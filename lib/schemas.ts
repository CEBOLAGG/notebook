...
export const machineSchema = z.object({
  ...
  ram_gb: z.number().optional().default(0),
  os: z.string().optional().default(''),
  os_version: z.string().optional().default(''),
  mac_address: z.string().nullable().optional(),
  tpm: z.string().optional().default(''),
  tpm_version: z.string().nullable().optional(),
  secure_boot: z.string().optional().default(''),
  autopilot: z.string().optional().default(''),
  windows_activation: z.string().optional().default(''),
  screen_resolution: z.string().optional().default(''),
  ...
  ntb_code: z.string().optional().default(''),
